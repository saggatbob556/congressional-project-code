...
windowConfirm = sg.Window('Confirm your product', layoutConfirm, size=(1200,600), finalize=True, location=(5000,5000))
windowConfirm.hide()
move_center(windowConfirm)
windowProduct = sg.Window('Product info', layoutProduct, size=(1300,800), finalize=True, location = (5000,5000))
windowProduct.hide()
move_center(windowProduct)

windowTry = sg.Window('Oops', layoutTryAgain, size=(1000,500), element_justification = 'center', finalize=True, location = (5000,5000))
windowTry.hide()
...
def barcode_title(input):
    api_key = "8s775b8fi3g0ek7l95ncjpn4aq61uj"
